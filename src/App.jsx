...
const App = () => {
  ...
  const handleChange = (field, value) => {
    ...
    // Auto-advance for single choice questions, but delay slightly for visual feedback
    if (field !== 'healthIssues' && field !== 'blacklist' && field !== 'age') {
  ...
  const finishFunnel = () => {
    ...
    // Simulate "Calculation" for credibility
    setTimeout(() => {
        ...
        return (
          ...
          >
            ...
            <OptionButton 
              ...
              subLabel="(Korrektur: nicht 'Selbständiger')"
      ...
      case 7: // Blacklist
        return (
          <QuestionStep 
            ...
            subtitle="Oder hast du bereits Ablehnungen erhalten? Das hilft uns beim Marktüberblick."
...
// The Pitch Page Component
const ResultPage = ({ formData }) => {
  // Simple logic to determine "Pitch Status"
  ...
  // Dynamic Savings calculation (Simulation)
  // GKV Max contribution approx 1050-1100 + Pflege. Let's assume around 1000 for calculation vs 500 PKV.
      ...
      <div className="p-6 md:p-8">
        ...
        <div className="text-center border-t border-slate-100 pt-6">
          ...
          <div className="space-y-3">
            <button className="w-full bg-blue-600 hover:bg-blue-700 text-white text-lg font-bold py-4 px-8 rounded-xl shadow-lg hover:shadow-blue-200/50 transition-all flex items-center justify-center gap-2">
              <Calculator className="w-5 h-5" />
              Ergebnis jetzt per Mail anfordern
            </button>
            
            <button className="w-full bg-white hover:bg-slate-50 text-slate-700 border-2 border-slate-200 font-bold py-4 px-8 rounded-xl transition-all">
              Termin vereinbaren
            </button>
          </div>
